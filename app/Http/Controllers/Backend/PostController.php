...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (is_numeric($categoryInput)) {
            ...
            // Assume it's a slug or name. Let's try slug first.
        ...
        if (is_null($categoryId)) {
            // Return a validation error if category is not found
            return response()->json(['success' => false, 'message' => 'Invalid category specified.']);
        }
